            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b-2 border-neutral-800">
                ...
                <div class="md:col-span-3 space-y-3">
                    ...
                    <ul class="space-y-2 text-sm text-neutral-300 font-bold">
                        ...
                        <li><a href="{{ route('facilities.index') }}" class="hover:text-brutal-pink transition-colors">Fasilitas Lengkap</a></li>
                        <li><a href="{{ route('gallery.index') }}" class="hover:text-brutal-pink transition-colors">Galeri Kost</a></li>
                        <li><a href="{{ route('location.index') }}" class="hover:text-brutal-pink transition-colors">Lokasi & Peta</a></li>
                        <li><a href="{{ route('faq.index') }}" class="hover:text-brutal-pink transition-colors">FAQ</a></li>
                    </ul>
                </div>
